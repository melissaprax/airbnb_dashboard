// Javascript can't access the file system, so we need to use a web server to serve the file

// Repeat: We need to use a web server to serve the file.
...
// Write function for only Staten Island subset
